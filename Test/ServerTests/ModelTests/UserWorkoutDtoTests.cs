///FIle Name UserWorkoutDtoTests.cs
...
{
    public class UserWorkoutDtoTests
    {
        [Fact]
        public void UserWorkoutDto_GettersAndSetters_ReturnExpectedValues()
        {
            // Arrange
            var userWorkout = new UserWorkoutDto();
